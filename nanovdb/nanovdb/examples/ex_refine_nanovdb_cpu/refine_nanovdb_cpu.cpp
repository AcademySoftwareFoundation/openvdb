...
int main(int argc, char *argv[])
{
    ...
    try {
        ...
        // Refinement (CPU/OpenVDB version), used as the correctness reference
        ...
        // Convert to indexGrid (refined reference)
        cpuTimer.start("Converting openVDB input to indexGrid (refined version)");
        auto handleRefined = nanovdb::tools::openToIndexVDB<BuildT, nanovdb::HostBuffer>(
            refinedGrid,
            0u,    // Don't copy data channel
            false, // No stats
            false, // No tiles
        ...
        mainRefineGrid( indexGridOriginal, indexGridRefined, benchmark_iters );
