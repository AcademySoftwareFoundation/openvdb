...
public:
    ...
    /// WENO upwinding and Godunov's scheme) at the previously buffered location.
    ///
    /// @note This method takes as input the grid geometry and the stencil array
    __hostdev__ static inline ValueType normSqGrad(const ValueType *v, const ValueType invDx2, const ValueType dx2, ValueType isoValue = ValueType(0))
    {
        // const ValueType* v = mValues;
        const RealT
    ...
    ///
    /// @note This method takes as input the grid geometry and the stencil array
    __hostdev__ static inline Vec3<ValueType> gradient(const ValueType *v, const ValueType inv2Dx)
    {
