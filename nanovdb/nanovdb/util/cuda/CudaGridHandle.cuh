...
cudaSplitGridHandles(const GridHandle<BufferT> &handle, const BufferT* other = nullptr)
{
...
{ return cudaSplitGridHandles(handle, other); }
...
cudaMergeGridHandles(const VectorT<GridHandle<BufferT>> &handles, const BufferT* other = nullptr)
{
    uint64_t size = 0u;
...
{ return cudaMergeGridHandles(handles, other); }
