...
ALIASES += vdbnamespace="openvdb::v3_0_0"
PREDEFINED = OPENVDB_VERSION_NAME=v3_0_0
...
ALIASES += ijk="@f$(i,j,k)@f$"
ALIASES += xyz="@f$(x,y,z)@f$"
ALIASES += const="<tt>const</tt>"
# Use this command to create a link to an OpenVDB class, function, etc.
# Usage is "@vdblink::<symbol> <text>@endlink", where <symbol> is a fully
# namespace-qualified symbol minus the openvdb and version number namespaces
# and <text> is the text of the link.
# Example: @vdblink::tree::RootNode root node@endlink
ALIASES += vdblink="@link @vdbnamespace"
