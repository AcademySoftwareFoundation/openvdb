...
{
    return py::object(py::handle<>(py::borrowed(obj)));
}
...
{
    return py::extract<ValueT>(pyBorrow(obj)[idx]);
}
...
/// than the one that would be generated by py::extract(), e.g.,
...
str(const T& val)
{
    return py::extract<std::string>(py::str(val));
}
