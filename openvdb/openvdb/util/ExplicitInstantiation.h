...
#define OPENVDB_INSTANTIATE template OPENVDB_EXPORT
#define OPENVDB_INSTANTIATE_CLASS template class OPENVDB_EXPORT
#define OPENVDB_INSTANTIATE_STRUCT template struct OPENVDB_EXPORT
