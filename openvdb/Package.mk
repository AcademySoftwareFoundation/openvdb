...
ARGS += -DCMAKE_EXEC_LINKER_FLAGS=-Wl,--as-needed
ARGS += -DCMAKE_MODULE_LINKER_FLAGS=-Wl,--as-needed
...
ARGS += -DBOOST_ROOT:PATH=$(BOOST_PACKAGE_ROOT)
ARGS += -DTBB_LOCATION:PATH=$(TBB_PACKAGE_ROOT)
ARGS += -DILMBASE_LOCATION:PATH=$(ILMBASE_PACKAGE_ROOT)
ARGS += -DOPENEXR_LOCATION:PATH=$(OPENEXR_PACKAGE_ROOT)
ARGS += -DCPPUNIT_LOCATION:PATH=$(CPPUNIT_PACKAGE_ROOT)
ARGS += -DGLFW_LOCATION:PATH=$(GLFW_PACKAGE_ROOT)
ARGS += -DBLOSC_LOCATION:PATH=$(BLOSC_PACKAGE_ROOT)
