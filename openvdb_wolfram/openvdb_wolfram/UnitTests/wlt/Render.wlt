...
VerificationTest[(* 6 *)
	{
OpenVDBLink`OpenVDBLevelSetViewer[], 
OpenVDBLink`OpenVDBLevelSetViewer["error"],
OpenVDBLink`OpenVDBLevelSetViewer[vdb, "error"],
OpenVDBLink`OpenVDBLevelSetViewer[vdb, "Soft", "error"]
}
	,
...
VerificationTest[(* 12 *)
	{
OpenVDBLink`OpenVDBLevelSetRender[], 
OpenVDBLink`OpenVDBLevelSetRender["error"],
OpenVDBLink`OpenVDBLevelSetRender[vdb, "error"],
OpenVDBLink`OpenVDBLevelSetRender[vdb, "Soft", "error"]
}
	,
	{$Failed, $Failed, $Failed, $Failed}	
]
...
VerificationTest[(* 21 *)
	im=OpenVDBLink`OpenVDBLevelSetRender[vdb, Background->Red, "FrameTranslation"->Automatic, ImageResolution->72, "IsoValue"->0.04`, "OrthographicFrame"->Automatic, PerformanceGoal->"Quality", ImageSize->243, ViewAngle->35Degree, ViewCenter->Automatic, ViewPoint->{1., -2, 2}, ViewProjection->Automatic, ViewVertical->{.1, -1, .45}];
...
VerificationTest[(* 22 *)
	im=OpenVDBLink`OpenVDBLevelSetRender[vdb, {"Depth", Purple}, Background->Red, "FrameTranslation"->Automatic, ImageResolution->72, "IsoValue"->0.04`, "OrthographicFrame"->Automatic, PerformanceGoal->"Quality", "ClosedClipping"->True, ImageSize->243, ViewAngle->35Degree, ViewCenter->Automatic, ViewPoint->{1., -2, 2}, ViewProjection->Automatic, ViewVertical->{.1, -1, .45}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 23 *)
	im=OpenVDBLink`OpenVDBLevelSetRender[vdb, {"Matte", Purple, Green}, Background->Red, "FrameTranslation"->Automatic, ImageResolution->72, "IsoValue"->0.04`, "OrthographicFrame"->Automatic, PerformanceGoal->"Quality", ImageSize->243, ViewAngle->35Degree, ViewCenter->Automatic, ViewPoint->{1., -2, 2}, ViewProjection->Automatic, ViewVertical->{.1, -1, .45}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 24 *)
	im=OpenVDBLink`OpenVDBLevelSetRender[vdb, {"Matte", "Soft"}, Background->ColorData[112, 3], "FrameTranslation"->Automatic, ImageResolution->72, "IsoValue"->0.04`, "OrthographicFrame"->Automatic, PerformanceGoal->"Quality", ImageSize->243, ViewAngle->35Degree, ViewCenter->Automatic, ViewPoint->{1., -2, 2}, ViewProjection->"Orthographic", ViewVertical->{.1, -1, .45}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
