...
VerificationTest[(* 5 *)
	{
OpenVDBLink`OpenVDBExport[], 
OpenVDBLink`OpenVDBExport["error"],
OpenVDBLink`OpenVDBExport["file", "error"],
OpenVDBLink`OpenVDBExport["error", bmr, "error"]
}
	,
...
VerificationTest[(* 10 *)
	{
OpenVDBLink`OpenVDBImport[], 
OpenVDBLink`OpenVDBImport[FileNameJoin[{CreateUUID[], "file.vdb"}]],
OpenVDBLink`OpenVDBImport["file", "error"],
OpenVDBLink`OpenVDBImport["file", Automatic, "error"],
OpenVDBLink`OpenVDBImport["file", Automatic, "Scalar", "error"]
}
	,
...
VerificationTest[(* 11 *)
	(
temporaryFile=Function[body, 
WithCleanup[
filename=FileNameJoin[{$TemporaryDirectory, CreateUUID[]<>".vdb"}], 
body,
DeleteFile[filename]
],
HoldFirst
...
vdbempty=OpenVDBLink`OpenVDBCreateGrid[1.0, "Scalar"];
vdb=OpenVDBLink`OpenVDBLevelSet[bmr];
fog=OpenVDBLink`OpenVDBFogVolume[vdb];
...
OpenVDBLink`$OpenVDBHalfWidth=3.0;
bmr=ExampleData[{"Geometry3D", "Triceratops"}, "BoundaryMeshRegion"];
vdbempty=OpenVDBLink`OpenVDBCreateGrid[1.0, "Double"];
