...
VerificationTest[(* 6 *)
	{
OpenVDBLink`OpenVDBImage3D[], 
OpenVDBLink`OpenVDBImage3D["error"],
OpenVDBLink`OpenVDBImage3D[bmr, "error"],
OpenVDBLink`OpenVDBImage3D[bmr, {{0, 1}, {0, 1}, {0, 1}}, "error"]
}
	,
...
VerificationTest[(* 12 *)
	{
OpenVDBLink`OpenVDBDepthImage[], 
OpenVDBLink`OpenVDBDepthImage["error"],
OpenVDBLink`OpenVDBDepthImage[bmr, "error"],
OpenVDBLink`OpenVDBDepthImage[bmr, Automatic, "error"],
OpenVDBLink`OpenVDBDepthImage[bmr, Automatic, 2.0, "error"],
OpenVDBLink`OpenVDBDepthImage[bmr, Automatic, 2.0, {0, 1}, "error"]
}
	,
...
VerificationTest[(* 18 *)
	{
OpenVDBLink`OpenVDBProjectionImage[], 
OpenVDBLink`OpenVDBProjectionImage["error"],
OpenVDBLink`OpenVDBProjectionImage[bmr, "error"],
OpenVDBLink`OpenVDBProjectionImage[bmr, Automatic, "error"]
}
	,
	{$Failed, $Failed, $Failed, $Failed}	
]
...
VerificationTest[(* 24 *)
	{
OpenVDBLink`OpenVDBSliceImage[], 
OpenVDBLink`OpenVDBSliceImage["error"],
OpenVDBLink`OpenVDBSliceImage[bmr, "error"],
OpenVDBLink`OpenVDBSliceImage[bmr, 0, "error"],
OpenVDBLink`OpenVDBSliceImage[bmr, 0, {{0, 1}, {0, 1}}, "error"]
}
	,
...
VerificationTest[(* 30 *)
	{
OpenVDBLink`OpenVDBDynamicSliceImage[], 
OpenVDBLink`OpenVDBDynamicSliceImage["error"],
OpenVDBLink`OpenVDBDynamicSliceImage[bmr, "error"]
}
	,
...
VerificationTest[(* 33 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32, 41}, 0.14580689491242496}	
]

VerificationTest[(* 34 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, Automatic];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32, 41}, 0.14580689491242496}	
]
...
VerificationTest[(* 35 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32, 41}, 0.14580689491242496}	
]
...
VerificationTest[(* 36 *)
	im=OpenVDBLink`OpenVDBImage3D[fog];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 37 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, {{0, 30}, {0, 30}, {0, 30}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 38 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, {0, 30}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 39 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, {0, 2.3}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 40 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, {{0.1, 1.3}, {.47, 2.3}, {0, 2.3}}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 41 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, {{0, 10}, {0, 10}, {-3, 10}}->"Index"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 42 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, "ScalingFactor"->1.3, Resampling->"Nearest"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 43 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, "ScalingFactor"->1.3, Resampling->"Linear"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 44 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, "ScalingFactor"->1.3, Resampling->"Quadratic"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 45 *)
	im=OpenVDBLink`OpenVDBImage3D[bmr, "ScalingFactor"->0.5];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 46 *)
	im=OpenVDBLink`OpenVDBDepthImage[bmr];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 47 *)
	im=OpenVDBLink`OpenVDBDepthImage[bmr, Automatic];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.4955575923834528}	
]
...
VerificationTest[(* 48 *)
	im=OpenVDBLink`OpenVDBDepthImage[vdb];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.4955575923834528}	
]
...
VerificationTest[(* 49 *)
	im=OpenVDBLink`OpenVDBDepthImage[fog];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 50 *)
	im=OpenVDBLink`OpenVDBDepthImage[bmr, {{0, 30}, {0, 30}, {0, 30}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 51 *)
	im=OpenVDBLink`OpenVDBDepthImage[bmr, {0, 30}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 52 *)
	im=OpenVDBLink`OpenVDBDepthImage[bmr, {0, 2.3}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 53 *)
	im=OpenVDBLink`OpenVDBDepthImage[bmr, {{0.1, 1.3}, {.47, 2.3}, {0, 2.3}}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 54 *)
	im=OpenVDBLink`OpenVDBDepthImage[bmr, {{0, 10}, {0, 10}, {-3, 10}}->"Index"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 55 *)
	im=OpenVDBLink`OpenVDBDepthImage[bmr, {{0, 10}, {0, 10}, {-3, 10}}->"World", 2.53];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 56 *)
	im=OpenVDBLink`OpenVDBDepthImage[bmr, Automatic, 2.0, {0.1, 1}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 57 *)
	im=OpenVDBLink`OpenVDBProjectionImage[bmr];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 58 *)
	im=OpenVDBLink`OpenVDBProjectionImage[bmr, Automatic];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.5658482142857143}	
]
...
VerificationTest[(* 59 *)
	im=OpenVDBLink`OpenVDBProjectionImage[vdb];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.5658482142857143}	
]
...
VerificationTest[(* 60 *)
	im=OpenVDBLink`OpenVDBProjectionImage[fog];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 61 *)
	im=OpenVDBLink`OpenVDBProjectionImage[bmr, {{0, 30}, {0, 30}, {0, 30}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 62 *)
	im=OpenVDBLink`OpenVDBProjectionImage[bmr, {0, 30}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 63 *)
	im=OpenVDBLink`OpenVDBProjectionImage[bmr, {0, 2.3}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.5293898809523809}	
]
...
VerificationTest[(* 64 *)
	im=OpenVDBLink`OpenVDBProjectionImage[bmr, {{0.1, 1.3}, {.47, 2.3}, {0, 2.3}}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 65 *)
	im=OpenVDBLink`OpenVDBProjectionImage[bmr, {{0, 10}, {0, 10}, {-3, 10}}->"Index"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 66 *)
	im=OpenVDBLink`OpenVDBSliceImage[bmr, 0];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 67 *)
	im=OpenVDBLink`OpenVDBSliceImage[bmr, 4->"Index"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 68 *)
	im=OpenVDBLink`OpenVDBSliceImage[bmr, 0.5->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 69 *)
	im=OpenVDBLink`OpenVDBSliceImage[bmr, 0.5->"World", {{-.5, 1.3}, {-.5, 2.3}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 70 *)
	im=OpenVDBLink`OpenVDBSliceImage[bmr, 5->"Index", {{-20, 20}, {-10, 10}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 78 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, Automatic];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32, 41}, 0.14580689491242496}	
]
...
VerificationTest[(* 81 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, {{0, 30}, {0, 30}, {0, 30}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {31, 31, 31}, 0.07659452354672187}	
]
...
VerificationTest[(* 82 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, {0, 30}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32, 31}, 0.11072525112195607}	
]
...
VerificationTest[(* 83 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, {0, 2.3}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32, 24}, 0.14302011603252657}	
]
...
VerificationTest[(* 84 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, {{0.1, 1.3}, {.47, 2.3}, {0, 2.3}}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {13, 19, 24}, 0.1036027096398614}	
]
...
VerificationTest[(* 85 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, {{0, 10}, {0, 10}, {-3, 10}}->"Index"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {11, 11, 14}, 0.2601407505150823}	
]
...
VerificationTest[(* 86 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, "ScalingFactor"->1.3, Resampling->"Nearest"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {109, 42, 53}, 0.14423111579175063}	
]
...
VerificationTest[(* 87 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, "ScalingFactor"->1.3, Resampling->"Linear"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 88 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, "ScalingFactor"->1.3, Resampling->"Quadratic"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
...
VerificationTest[(* 89 *)
	im=OpenVDBLink`OpenVDBImage3D[vdb, "ScalingFactor"->0.5];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {43, 17, 21}, 0.1301091708913388}	
]
...
VerificationTest[(* 91 *)
	im=OpenVDBLink`OpenVDBDepthImage[vdb, Automatic];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.4955575923834528}	
]
...
VerificationTest[(* 94 *)
	im=OpenVDBLink`OpenVDBDepthImage[vdb, {{0, 30}, {0, 30}, {0, 30}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {31, 31}, 0.2444580956192592}	
]
...
VerificationTest[(* 95 *)
	im=OpenVDBLink`OpenVDBDepthImage[vdb, {0, 30}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.35676031767035876}	
]
...
VerificationTest[(* 96 *)
	im=OpenVDBLink`OpenVDBDepthImage[vdb, {0, 2.3}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.4031068659831016}	
]
...
VerificationTest[(* 97 *)
	im=OpenVDBLink`OpenVDBDepthImage[vdb, {{0.1, 1.3}, {.47, 2.3}, {0, 2.3}}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {13, 19}, 0.2537302976919089}	
]
...
VerificationTest[(* 98 *)
	im=OpenVDBLink`OpenVDBDepthImage[vdb, {{0, 10}, {0, 10}, {-3, 10}}->"Index"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {11, 11}, 0.8025942667702998}	
]
...
VerificationTest[(* 99 *)
	im=OpenVDBLink`OpenVDBDepthImage[vdb, {{0, 10}, {0, 10}, {-3, 10}}->"World", 2.53];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {101, 101}, 0.014254320773315505}	
]
...
VerificationTest[(* 100 *)
	im=OpenVDBLink`OpenVDBDepthImage[vdb, Automatic, 2.0, {0.1, 1}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.4101067692806412}	
]
...
VerificationTest[(* 102 *)
	im=OpenVDBLink`OpenVDBProjectionImage[vdb, Automatic];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.5658482142857143}	
]
...
VerificationTest[(* 105 *)
	im=OpenVDBLink`OpenVDBProjectionImage[vdb, {{0, 30}, {0, 30}, {0, 30}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {31, 31}, 0.3506763787721124}	
]
...
VerificationTest[(* 106 *)
	im=OpenVDBLink`OpenVDBProjectionImage[vdb, {0, 30}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.5293898809523809}	
]
...
VerificationTest[(* 107 *)
	im=OpenVDBLink`OpenVDBProjectionImage[vdb, {0, 2.3}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.5293898809523809}	
]
...
VerificationTest[(* 108 *)
	im=OpenVDBLink`OpenVDBProjectionImage[vdb, {{0.1, 1.3}, {.47, 2.3}, {0, 2.3}}->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {13, 19}, 0.3562753036437247}	
]
...
VerificationTest[(* 109 *)
	im=OpenVDBLink`OpenVDBProjectionImage[vdb, {{0, 10}, {0, 10}, {-3, 10}}->"Index"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {11, 11}, 0.9090909090909091}	
]
...
VerificationTest[(* 110 *)
	im=OpenVDBLink`OpenVDBSliceImage[vdb, 0];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.19166812558356686}	
]
...
VerificationTest[(* 111 *)
	im=OpenVDBLink`OpenVDBSliceImage[vdb, 4->"Index"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.19799544817927173}	
]
...
VerificationTest[(* 112 *)
	im=OpenVDBLink`OpenVDBSliceImage[vdb, 0.5->"World"];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {84, 32}, 0.19392507002801124}	
]
...
VerificationTest[(* 113 *)
	im=OpenVDBLink`OpenVDBSliceImage[vdb, 0.5->"World", {{-.5, 1.3}, {-.5, 2.3}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {19, 29}, 0.11333404505177759}	
]
...
VerificationTest[(* 114 *)
	im=OpenVDBLink`OpenVDBSliceImage[vdb, 5->"Index", {{-20, 20}, {-10, 10}}];
{ImageQ[im], ImageDimensions[im], Mean[im]}
	,
	{True, {41, 21}, 0.26237616998018753}	
]
