...
nanovdb::GridHandle<PytorchDeviceBuffer> buildPaddedGridFromGridWithoutBorderCPU(const GridBatchImpl& baseBatchHdl, int BMIN, int BMAX) {
...
template <typename GridType>
nanovdb::GridHandle<PytorchDeviceBuffer> buildPaddedGridFromGridCPU(const GridBatchImpl& baseBatchHdl, int BMIN, int BMAX) {
    TORCH_CHECK(BMIN <= BMAX, "BMIN must be less than BMAX");
