...
nanovdb::GridHandle<PytorchDeviceBuffer> buildGridFromMeshCPU(const JaggedTensor& vertices,
    ...
    batchHandles.reserve(vertices.batch_size());

    for (int64_t bidx = 0; bidx < vertices.batch_size(); bidx += 1) {
