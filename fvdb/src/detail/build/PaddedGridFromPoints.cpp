...
nanovdb::GridHandle<PytorchDeviceBuffer> buildPaddedGridFromPointsCPU(const JaggedTensor& pointsJagged,
    ...
    return AT_DISPATCH_FLOATING_TYPES_AND_HALF(pointsJagged.scalar_type(), "buildPaddedGridFromPoints", [&](){
        ...
        const torch::TensorAccessor<int64_t, 2>& pointsBOffsetsAcc = pointsJagged.joffsets().accessor<int64_t, 2>();
