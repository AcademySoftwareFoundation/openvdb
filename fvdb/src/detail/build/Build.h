...
nanovdb::GridHandle<PytorchDeviceBuffer> buildCoarseGridFromFineGrid(bool isMutable,
...
nanovdb::GridHandle<PytorchDeviceBuffer> buildConvGridFromGrid(bool isMutable,
...
nanovdb::GridHandle<PytorchDeviceBuffer> buildPaddedGridFromGrid(bool isMutable,
                                                                 const GridBatchImpl& baseGridHdl,
...
nanovdb::GridHandle<PytorchDeviceBuffer> buildPaddedGridFromPoints(bool isMutable,
...
/// @param tx Transform from world to voxel coordinates
/// @return A handle to the nanovdb grid (the device will match points)
nanovdb::GridHandle<PytorchDeviceBuffer> buildNearestNeighborGridFromPoints(bool isMutable,
                                                                            const JaggedTensor& points,
                                                                            const std::vector<VoxelCoordTransform>& tx);
...
nanovdb::GridHandle<PytorchDeviceBuffer> buildGridFromMesh(bool isMutable,
