...
nanovdb::GridHandle<PytorchDeviceBuffer> buildCoarseGridFromFineGridCPU(const GridBatchImpl& fineBatchHdl,
                                                                        const nanovdb::Coord branchingFactor) {

    using IndexTree = nanovdb::NanoTree<GridType>;

    const nanovdb::GridHandle<PytorchDeviceBuffer>& fineGridHdl = fineBatchHdl.nanoGridHandle();
...
template <typename GridType>
nanovdb::GridHandle<PytorchDeviceBuffer> buildConvGridFromGridCPU(const GridBatchImpl& baseBatchHdl,
    ...
    const nanovdb::GridHandle<PytorchDeviceBuffer>& baseGridHdl = baseBatchHdl.nanoGridHandle();
    std::vector<nanovdb::GridHandle<PytorchDeviceBuffer>> batchHandles;
