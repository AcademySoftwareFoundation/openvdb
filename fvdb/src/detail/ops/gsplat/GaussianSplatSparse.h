...
///   3. tile_pixel_cumsum: An int64 Tensor with shape [AT] encoding the cumulative sum of
///      active pixels in each active tile.
///   4. pixel_map: An int64 Tensor with shape [AP] specifying the write order of pixels within
///      tiles.
...
/// @return Tuple of (active_tiles, tile_pixel_mask, tile_pixel_cumsum, pixel_map)
