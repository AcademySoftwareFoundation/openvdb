...
dispatchGaussianFullyFusedProjectionJaggedForward<torch::kCUDA>(
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatchGaussianFullyFusedProjectionJaggedForward<torch::kCPU>(
    const torch::Tensor &g_sizes,  // [B] gaussian sizes
    const torch::Tensor &means,    // [ggz, 3]
    const torch::Tensor &quats,    // [ggz, 4] optional
    const torch::Tensor &scales,   // [ggz, 3] optional
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatchGaussianFullyFusedProjectionJaggedBackward<torch::kCUDA>(
    const torch::Tensor &g_sizes,  // [B] gaussian sizes
    const torch::Tensor &means,    // [ggz, 3]
    const torch::Tensor &quats,    // [ggz, 4] optional
    const torch::Tensor &scales,   // [ggz, 3] optional
...
template <>
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>
dispatchGaussianFullyFusedProjectionJaggedBackward<torch::kCPU>(
    const torch::Tensor &g_sizes,   // [B] gaussian sizes
    const torch::Tensor &means,     // [ggz, 3]
    const torch::Tensor &quats,     // [ggz, 4] optional
    const torch::Tensor &scales,    // [ggz, 3] optional
