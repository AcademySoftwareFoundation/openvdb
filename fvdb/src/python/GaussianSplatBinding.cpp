...
bind_gaussian_splat3d(py::module &m) {
    ...
    gs3d.def(py::init<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor,
                      torch::Tensor, bool>(),
             py::arg("means"), py::arg("quats"), py::arg("log_scales"), py::arg("logit_opacities"),
             py::arg("sh0"), py::arg("shN"), py::arg("requires_grad") = false)
        ...
        .def_property("log_scales", &fvdb::GaussianSplat3d::logScales,
                      &fvdb::GaussianSplat3d::setLogScales)
        .def_property_readonly("opacities", &fvdb::GaussianSplat3d::opacities)
        .def_property("logit_opacities", &fvdb::GaussianSplat3d::logitOpacities,
        ...
        .def_property("track_max_2d_radii_for_grad", &fvdb::GaussianSplat3d::trackMax2dRadiiForGrad,
        ...
        .def_property("requires_grad", &fvdb::GaussianSplat3d::requiresGrad,
                      &fvdb::GaussianSplat3d::setRequiresGrad)
        .def("set_state", &fvdb::GaussianSplat3d::setState, py::arg("means"), py::arg("quats"),
             py::arg("log_scales"), py::arg("logit_opacities"), py::arg("sh0"), py::arg("shN"),
             py::arg("requires_grad") = false)
        .def("save_ply", &fvdb::GaussianSplat3d::savePly, py::arg("filename"))

        .def("reset_grad_state", &fvdb::GaussianSplat3d::resetGradState)
        .def("project_gaussians_for_images", &fvdb::GaussianSplat3d::projectGaussiansForImages,
        ...
        .def("project_gaussians_for_depths", &fvdb::GaussianSplat3d::projectGaussiansForDepths,
             py::arg("world_to_camera_matrices"), py::arg("projection_matrices"),
             py::arg("image_width"), py::arg("image_height"), py::arg("near"), py::arg("far"),
             py::arg("projection_type") = fvdb::GaussianSplat3d::ProjectionType::PERSPECTIVE,
        ...
        .def("render_from_projected_gaussians",
             &fvdb::GaussianSplat3d::renderFromProjectedGaussians, py::arg("projected_gaussians"),
    ...
    m.def("gaussian_render_jagged", &fvdb::gaussianRenderJagged, py::arg("means"), py::arg("quats"),
          ...
          py::arg("return_debug_info") = false, py::arg("ortho") = false);
}
